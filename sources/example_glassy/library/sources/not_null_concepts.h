...
constexpr FORCEINLINE auto GetPtr(
    is_not_null_of_raw_pointer auto&& lhs) noexcept -> decltype(auto) {
  return lhs;
}

constexpr FORCEINLINE auto GetPtr(is_not_null auto&& lhs) noexcept
    -> decltype(auto) {
