{
  ...
  ast = {
    groups = [ "code_quality" "default" "development" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  bundler-leak = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "156w6ygj0a5ji1lymhwy3bxckdjkdwjz9c8pscc99zzkxy9djl5f";
      type = "gem";
    };
    version = "0.2.0";
  };
  ...
  flog = {
    dependencies = [ "path_expander" "ruby_parser" "sexp_processor" ];
    groups = [ "code_quality" "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0qy7s5q450wbc78av8h0w8inrdz46vp4rqnm5ikpsnh7dilh7amm";
      type = "gem";
    };
    version = "4.6.4";
  };
  ...
  gemsmith = {
    dependencies = [ "git_plus" "milestoner" "pragmater" "refinements" "rubocop" "runcom" "thor" "tocer" "versionaire" ];
    groups = [ "development" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0j69yj7ay0avrhk9sz71m26dwdvin3bz7xs2bcprmla65967pz7a";
      type = "gem";
    };
    version = "15.3.0";
  };
  git-lint = {
    dependencies = [ "git_plus" "pastel" "refinements" "runcom" "thor" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1n448yw8r82c7kd0l50adlx1dc26cjxwgkh1qlgnbqdsk61lk4kp";
      type = "gem";
    };
    version = "2.2.0";
  };
  git_plus = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1pvlf1fv7j1qxdrfqsrhhv90m8lh2cv6b9xdrh3w5cyisygfw4n0";
      type = "gem";
    };
    version = "0.4.0";
  };
  ...
  milestoner = {
    dependencies = [ "git_plus" "refinements" "runcom" "thor" "versionaire" ];
    groups = [ "default" "development" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1bx2zfrxkkmbpxcx8w3pck40l38zknzjfwwjfl09g72mia7xb8s8";
      type = "gem";
    };
    version = "11.2.0";
  };
  ...
  pragmater = {
    dependencies = [ "refinements" "runcom" ];
    groups = [ "default" "development" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1d4mnhm0si8z9kqbfxqzh7zri665alwm54wzxs77gx67aqxpvcn8";
      type = "gem";
    };
    version = "9.1.0";
  };
  ...
  psych = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "12n4v9a44mppw1z7zsqir04mcpna1sc3qphbgwl0va5ib7mya09a";
      type = "gem";
    };
    version = "3.3.1";
  };
  ...
  reek = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1zlfvj1dh064y119sfz9w3rkj3d9qkwm1k6dkcjymr6cwj6cqqp2";
      type = "gem";
    };
    version = "6.0.3";
  };
  refinements = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1nfs9pih89mw6x6179p94gb1g9an658dpz3wpnkyldmnkk76ghv6";
      type = "gem";
    };
    version = "8.1.0";
  };
  ...
  rubocop = {
    ...
    groups = [ "code_quality" "development" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  rubycritic = {
    dependencies = [ "flay" "flog" "launchy" "parser" "rainbow" "reek" "ruby_parser" "simplecov" "tty-which" "virtus" ];
    groups = [ "code_quality" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "15chn41xfs2x7370ca3dm2d3a0891ngcivvlph4mkrs85bccnc0m";
      type = "gem";
    };
    version = "4.6.1";
  };
  runcom = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0if8m2l5d33b0vjg6lm34sr064z5svcfk070rfrlhal0schydw0k";
      type = "gem";
    };
    version = "7.1.0";
  };
  ...
  thor = {
    groups = [ "code_quality" "default" "development" "test" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
  ...
  tocer = {
    dependencies = [ "refinements" "runcom" "thor" ];
    groups = [ "default" "development" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0ns5m8pjcsq7vhnim017am3vgnpf09bivpwm78yk119q5974snbz";
      type = "gem";
    };
    version = "11.1.0";
  };
  ...
  versionaire = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0xrj07is14hyz8pgy2dypqhzr476n1cfyxx4rhkkkl9nd58d8wri";
      type = "gem";
    };
    version = "9.1.0";
  };
  ...
  xdg = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1krz96l96wspgrabdp0f9x61chg3mi97pwsk48j1as8m6mwas5dh";
      type = "gem";
    };
    version = "5.1.0";
  };
